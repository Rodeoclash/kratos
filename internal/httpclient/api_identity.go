...
type IdentityApi interface {
	...
	*/
	...
	/*
			 * PatchIdentities Create and deletes multiple identities
		...
		for instance passwords, social sign in configurations or multifactor methods.
			 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			 * @return IdentityApiApiPatchIdentitiesRequest
	*/
	PatchIdentities(ctx context.Context) IdentityApiApiPatchIdentitiesRequest

	/*
	 * PatchIdentitiesExecute executes the request
	 * @return PatchIdentitiesResponse
	 */
	PatchIdentitiesExecute(r IdentityApiApiPatchIdentitiesRequest) (*PatchIdentitiesResponse, *http.Response, error)
...
type IdentityApiApiPatchIdentitiesRequest struct {
	ctx                 context.Context
	ApiService          IdentityApi
	patchIdentitiesBody *PatchIdentitiesBody
}

func (r IdentityApiApiPatchIdentitiesRequest) PatchIdentitiesBody(patchIdentitiesBody PatchIdentitiesBody) IdentityApiApiPatchIdentitiesRequest {
	r.patchIdentitiesBody = &patchIdentitiesBody
	return r
}

func (r IdentityApiApiPatchIdentitiesRequest) Execute() (*PatchIdentitiesResponse, *http.Response, error) {
	return r.ApiService.PatchIdentitiesExecute(r)
}
...
for instance passwords, social sign in configurations or multifactor methods.
  ...
  - @return IdentityApiApiPatchIdentitiesRequest
*/
func (a *IdentityApiService) PatchIdentities(ctx context.Context) IdentityApiApiPatchIdentitiesRequest {
	return IdentityApiApiPatchIdentitiesRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 * @return PatchIdentitiesResponse
 */
func (a *IdentityApiService) PatchIdentitiesExecute(r IdentityApiApiPatchIdentitiesRequest) (*PatchIdentitiesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  *PatchIdentitiesResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IdentityApiService.PatchIdentities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
